<template>
  ...
  class="">
    ...
    class="py-1 px-6 w-full relative text-md border-4 border-black rounded-full font-bold hover:text-white hover:bg-black focus:text-gray-400 focus:outline-none"
