<template>
  ...
  class="">
    ...
    class="py-2 px-6 w-full relative text-sm border-4 border-black rounded-full font-bold hover:text-white hover:bg-black focus:text-gray-400 focus:outline-none"
